...
- 🔥 **Source**: ```2025/10/18```: Add [🧨 Diffusers](https://huggingface.co/collections/ai-forever/kandinsky-50-t2v-lite-diffusers-68dd73ebac816748ed79d6cb) support. Kandinsky 5.0 T2V Lite models can now be used in [🧨 Diffusers](https://huggingface.co/docs/diffusers/index)
