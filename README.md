...
## Project Updates
- 🔥 ```2025/11/22```: LoRas for Camera control is open-sourced. Inference code is avaibale in `examples/inference_examples_i2v_lora.ipynb` and `examples/inference_examples_t2v_lora.ipynb`
